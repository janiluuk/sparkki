    ...
    <div className="mx-auto max-w-lg px-4 py-16 text-center">
      ...
      <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:justify-center">
        <button
          type="button"
          onClick={() => reset()}
          className="min-h-tap rounded-lg bg-verso-green px-6 py-3 font-semibold text-canvas focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-g"
        >
          {t("retry")}
        </button>
        <Link
