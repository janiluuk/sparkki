...
- Point Verso at **`https://YOUR_HOST:8443`** (no trailing slash) and trust Caddy’s root in the browser for lab use.
...
2. Set **`NEXT_PUBLIC_TRY_LINUX_ACCESS_TOKEN`** in Verso to the **same value** (public env — lab gate only).
